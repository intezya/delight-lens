...
export function RisksList({ risks }: { risks: string[] }) {
  ...
  return (
    <Card className="border-amber-300/60 bg-amber-50/60 p-6 dark:border-amber-500/20 dark:bg-amber-500/5 md:p-7">
      ...
      <ul className="stagger space-y-2">
        {risks.map((r) => (
          <li key={r} className="flex items-start gap-2.5 text-sm leading-snug text-foreground/90">
